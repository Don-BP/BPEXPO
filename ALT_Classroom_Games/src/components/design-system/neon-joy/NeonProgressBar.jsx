...
const NeonProgressBar = ({ value = 50, color = 'green', striped = false, showButton = true, className = '' }) => {
    ...
    const colors = {
        green: {
            bar: "bg-[#76e66e]",
            stripes: "from-[#76e66e] via-[#94f08e] to-[#76e66e]", // Simulating stripes via gradient not perfect, use CSS for stripes
            bg: "bg-[#2d1b4e]", // Dark background for contrast
    ...
    return (
        <div className={`flex items-center gap-2 ${className}`}>
            ...
            `}>
                ...
                {/* Text Label (Absolute centered or right aligned?) Ref shows right aligned inside or outside */}
