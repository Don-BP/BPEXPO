...
/**
 * RibbonHeader Component
 * 
 * A decorative ribbon that sits on top of cards.
 * 
 * @param {string} text - The text to display (e.g., "COMPLETE", "LEVEL 23")
 * @param {string} color - 'green', 'blue', 'red', 'yellow'
 * @param {string} subText - Optional small text below (e.g. key info)
 */
