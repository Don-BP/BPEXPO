...
import {
    Play, Pause, RotateCcw, ChevronRight, X, Music, FastForward, Info,
    Volume2, VolumeX, Settings, Plus, Save, Trash2, Edit3, Sparkles,
    CheckCircle2, AlertCircle, Shuffle, QrCode, Share2, Award, Zap
} from 'lucide-react';
...
const INITIAL_PACKS = [
    {
        ...
        words: [
            { text: 'Cat', icon: '🐱', color: '#FF9999' },
            { text: 'Dog', icon: '🐶', color: '#99FF99' },
            { text: 'Bird', icon: '🐦', color: '#9999FF' },
            { text: 'Fish', icon: '🐠', color: '#FFFF99' },
            { text: 'Lion', icon: '🦁', color: '#FFCC99' },
            { text: 'Tiger', icon: '🐯', color: '#FFCC99' },
            { text: 'Bear', icon: '🐻', color: '#C0C0C0' },
            { text: 'Frog', icon: '🐸', color: '#99FF99' },
        ]
    },
    {
        id: 'mext-grade3',
        name: 'MEXT Gr. 3 Basic',
        difficulty: 'Medium',
        category: 'MEXT',
        startingBPM: 120,
        accelerationRate: 4.5,
        words: [
            { text: 'Hello', icon: '👋', color: '#FF6B6B' },
            { text: 'Apple', icon: '🍎', color: '#FF6B6B' },
            { text: 'Book', icon: '📖', color: '#4facfe' },
            { text: 'Pencil', icon: '✏️', color: '#f6d365' },
            { text: 'Thank you', icon: '🙏', color: '#84fab0' },
            { text: 'Red', icon: '🟥', color: '#FF0000' },
            { text: 'Blue', icon: '🟦', color: '#0000FF' },
            { text: 'One', icon: '1️⃣', color: '#FFFFFF' },
        ]
    },
    {
        id: 'mext-grade5-food',
        ...
        accelerationRate: 6,
        words: [
            { text: 'Rice', icon: '🍚', color: '#FFFFFF' },
            { text: 'Bread', icon: '🍞', color: '#F4A460' },
            { text: 'Soup', icon: '🥣', color: '#FF6347' },
            { text: 'Milk', icon: '🥛', color: '#F0F8FF' },
            { text: 'Salad', icon: '🥗', color: '#32CD32' },
            { text: 'Pizza', icon: '🍕', color: '#FFA500' },
            { text: 'Pasta', icon: '🍝', color: '#FFFFE0' },
            { text: 'Fruit', icon: '🍎', color: '#FF4500' },
        ]
    },
    {
        id: 'phonics-blends',
        ...
        accelerationRate: 10,
        words: [
            { text: 'Star', icon: '⭐', color: '#FFD700' },
            { text: 'Stop', icon: '🛑', color: '#FF0000' },
            { text: 'Step', icon: '👣', color: '#8B4513' },
            { text: 'Stay', icon: '🏠', color: '#4169E1' },
            { text: 'Stick', icon: '🥢', color: '#DAA520' },
            { text: 'Stone', icon: '🪨', color: '#808080' },
            { text: 'Stump', icon: '🪵', color: '#A0522D' },
            { text: 'Store', icon: '🏪', color: '#FF69B4' },
        ]
    },
    {
        id: 'body-parts-medium',
        name: 'Body Boogie',
        difficulty: 'Medium',
        category: 'Thematic',
        startingBPM: 125,
        accelerationRate: 5,
        words: [
            { text: 'Head', icon: '🙆', color: '#FFDAB9' },
            { text: 'Shoulder', icon: '💪', color: '#FFDAB9' },
            { text: 'Knee', icon: '🦵', color: '#FFDAB9' },
            { text: 'Toe', icon: '🦶', color: '#FFDAB9' },
            { text: 'Eye', icon: '👁️', color: '#87CEEB' },
            { text: 'Ear', icon: '👂', color: '#FFDAB9' },
            { text: 'Mouth', icon: '👄', color: '#FF0000' },
            { text: 'Nose', icon: '👃', color: '#FFDAB9' },
        ]
    },
    {
        id: 'weather-hard',
        ...
        accelerationRate: 8,
        words: [
            { text: 'Sunny', icon: '☀️', color: '#FFD700' },
            { text: 'Rainy', icon: '🌧️', color: '#4682B4' },
            { text: 'Cloudy', icon: '☁️', color: '#D3D3D3' },
            { text: 'Snowy', icon: '❄️', color: '#F0FFFF' },
            { text: 'Windy', icon: '🌬️', color: '#ADD8E6' },
            { text: 'Stormy', icon: '⚡', color: '#4B0082' },
            { text: 'Rainbow', icon: '🌈', color: '#FF1493' },
            { text: 'Foggy', icon: '🌫️', color: '#778899' },
        ]
    }
];
...
// Utility: Difficulty Theme Mapping
const getDifficultyColor = (difficulty) => {
    switch (difficulty) {
        case 'Easy': return { variant: 'green', text: 'text-green-300', bg: 'bg-green-900/50', accent: 'text-green-400', glow: 'shadow-[0_0_80px_rgba(34,197,94,0.2)]', grad: 'from-green-600/20 to-emerald-600/20' };
        case 'Medium': return { variant: 'blue', text: 'text-blue-300', bg: 'bg-blue-900/50', accent: 'text-blue-400', glow: 'shadow-[0_0_80px_rgba(37,99,235,0.2)]', grad: 'from-blue-600/20 to-indigo-600/20' };
        case 'Hard': return { variant: 'purple', text: 'text-purple-300', bg: 'bg-purple-900/50', accent: 'text-purple-400', glow: 'shadow-[0_0_80px_rgba(168,85,247,0.2)]', grad: 'from-purple-600/20 to-pink-600/20' };
        case 'Impossible': return { variant: 'yellow', text: 'text-yellow-300', bg: 'bg-yellow-900/50', accent: 'text-yellow-400', glow: 'shadow-[0_0_80px_rgba(250,204,21,0.2)]', grad: 'from-yellow-600/20 to-orange-600/20' };
        default: return { variant: 'blue', text: 'text-blue-300', bg: 'bg-blue-900/50', accent: 'text-blue-400', glow: 'shadow-[0_0_80px_rgba(37,99,235,0.2)]', grad: 'from-blue-600/20 to-indigo-600/20' };
    }
};

const BeatChant = () => {
    // Game State
    const [gameState, setGameState] = useState('menu'); // 'menu', 'settings', 'countdown', 'playing', 'round-end', 'level-end', 'creator'
    const [selectedPack, setSelectedPack] = useState(INITIAL_PACKS[0]);
    ...
    const [overriddenDefaults, setOverriddenDefaults] = useState({}); // Key: pack.id, Value: packData
    const [editingPackId, setEditingPackId] = useState(null); // ID of pack being edited, or null for new
    ...
    const displayPacks = useMemo(() => {
        const processedDefaults = INITIAL_PACKS.map(pack =>
            overriddenDefaults[pack.id] ? { ...overriddenDefaults[pack.id], isModified: true } : pack
        );
        return [...processedDefaults, ...customPacks];
    ...
    const [creatorData, setCreatorData] = useState({
        ...
        difficulty: 'Medium',
        randomizeCards: true,
        // Store words for each round (1-5). Default to empty arrays of 8 slots.
        roundWords: {
            1: Array(8).fill({ text: '', icon: '❓' }),
            2: Array(8).fill({ text: '', icon: '❓' }),
            3: Array(8).fill({ text: '', icon: '❓' }),
            4: Array(8).fill({ text: '', icon: '❓' }),
            5: Array(8).fill({ text: '', icon: '❓' })
        }
    });
    ...
    const handleNextRoundRef = useRef(null);
    const startRoundRef = useRef(null);

    // Sync refs with state to avoid closure trapping in syncLoop
    useEffect(() => {
        roundPauseRef.current = roundPause;
    }, [roundPause]);
    ...
    const stopGame = useCallback((stopAudio = true) => {
        console.log('[BeatChant] stopGame. stopAudio:', stopAudio);
        if (timerRef.current) {
        ...
        if (stopAudio) {
            console.log('[BeatChant] stopGame: Stopping BGM');
            soundManager.stopBGM();
        }
    }, []);

    const handleExit = useCallback((targetState = 'menu') => {
        stopGame();
        setFadingOut(true);
        const exitAudio = `${import.meta.env.BASE_URL}audio/beat_chant_bgm/exit_win_loop.mp3`;
        soundManager.playBGM(exitAudio, 92, 92);
        setTimeout(() => {
            setGameState(targetState);
            setFadingOut(false);
            soundManager.stopBGM();
        }, 3000); // Duration of exit_win_loop
    }, [stopGame]);

    const triggerConfetti = useCallback((type = 'round') => {
        if (type === 'round') {
            confetti({
                particleCount: 50,
                spread: 70,
    ...
    const startRound = useCallback((bpm = currentBPM, continuous = false) => {
        console.log('[BeatChant] startRound. bpm:', bpm, 'continuous:', continuous);
        stopGame(!continuous);
        beatIndexRef.current = -1; // Start at -1 to trigger beat 0 correctly
        setActiveSlot(-1);
        setCountdown(8);
        setGameState('countdown');

        // Shuffle words between rounds
        // Check if we have specific words for this round
        const roundSpecificWords = selectedPack.roundWords?.[currentRound];
        const round1Words = selectedPack.roundWords?.[1] || selectedPack.words; // Fallback to classic structure if needed

        let wordsToUse = [];

        // FALLBACK LOGIC:
        // If specific round words exist and have some content (check first item), use them.
        // Otherwise, fallback to Round 1 words.
        // We check if at least one word in the specific round is set (text not empty).
        const hasSpecificWords = roundSpecificWords && roundSpecificWords.some(w => w.text.trim() !== '');

        if (hasSpecificWords) {
            wordsToUse = [...roundSpecificWords];
        } else {
            wordsToUse = [...round1Words];
        }

        // RANDOMIZATION LOGIC:
        // If randomizeCards is explicitly FALSE, do NOT shuffle.
        // If randomizeCards is TRUE (default), we shuffle.
        // EXCEPTION: If we are using fallback words (e.g. Round 2 using Round 1 words) AND randomization is ON,
        // we definitely want to shuffle them so Round 2 isn't identical to Round 1.

        let finalWords = [];
        if (selectedPack.randomizeCards !== false) {
            finalWords = shuffleArray(wordsToUse);
        } else {
            // If NOT randomized, just use them in order
            finalWords = wordsToUse;
        }

        setGameWords(finalWords);

        // Pick 4 random images for the edges - Force unique quadrants
        const shuffledImgs = shuffleArray(CHANT_BG_IMAGES);
        const quadrants = [
            { xRange: [0, 15], yRange: [0, 15] },     // Top Left
            { xRange: [75, 90], yRange: [0, 15] },    // Top Right
            { xRange: [0, 15], yRange: [75, 90] },    // Bottom Left
            { xRange: [75, 90], yRange: [75, 90] }    // Bottom Right
        ];
        const shuffledQuadrants = shuffleArray(quadrants);

        const selectedImgs = shuffledImgs.slice(0, 4).map((img, i) => {
            const quad = shuffledQuadrants[i];
            const x = quad.xRange[0] + Math.random() * (quad.xRange[1] - quad.xRange[0]);
            const y = quad.yRange[0] + Math.random() * (quad.yRange[1] - quad.yRange[0]);
            return {
                url: `${import.meta.env.BASE_URL}chant_bg_art/${img}`,
                x: `${x}%`,
                y: `${y}%`,
                baseRotation: Math.random() * 40 - 20,
                // Unique jitter parameters
                jumpHeight: 20 + Math.random() * 30, // 20px to 50px
                twistAmount: 10 + Math.random() * 25, // 10deg to 35deg
                scalePulse: 1.1 + Math.random() * 0.3, // 1.1x to 1.4x
                shakeX: Math.random() * 20 - 10 // -10px to 10px
            };
        });
        ...
        // SEAMLESS LOGIC:
        console.log(`[BeatChant] startRound Check. Continuous: ${continuous}`);
        const isAlreadyPlaying = soundManager.isBGMPlaying(beatAudio);

        if (continuous && isAlreadyPlaying) {
            console.log('[BeatChant] Seamless detected (Play+Cont). Adjusting tempo to:', bpm);
            soundManager.setBGMTempo(bpm);
            roundAnchorTime = soundManager.getAudioTime();
        } else {
            console.log(`[BeatChant] Full Start required. Continuous: ${continuous}, Playing: ${isAlreadyPlaying}`);
        ...
        const syncLoop = () => {
            ...
            if (!currentTime && !continuous) { // Allow waiting if starting, but if continuous it should be there
                timerRef.current = requestAnimationFrame(syncLoop);
                return;
            }

            // Latency compensation: Shift visuals forward by 50ms
            ...
            if (currentBeat !== beatIndexRef.current) {
                ...
                if (currentBeat < 8) {
                    // PHASE 1: 8-Beat Intro Countdown
                    setGameState('countdown');
                    setCountdown(8 - currentBeat);
                    playSound('metronome');
                } else if (currentBeat < 16) {
                    // PHASE 2: 8-Beat Gameplay (1 word per pulse)
                    setGameState('playing');
                    setActiveSlot(currentBeat - 8);
                    playSound('metronome');
                } else {
                    // PHASE 3: Round End / Transition
                    stopGame(roundPauseRef.current); // If seamless (roundPause=false), pass false to DON'T stop audio.
                    setActiveSlot(-1);
                    ...
                    if (roundPauseRef.current) {
                        ...
                        // SEAMLESS TRANSITION
                        // Reset beatIndexRef to avoid immediate re-trigger before handleNextRound clears timer
                        beatIndexRef.current = -1;
                        handleNextRoundRef.current();
                    }
                    return; // Stop current sequence
                }
            }
    ...
    const handleNextRound = useCallback(async () => {
        ...
        if (nextRound > totalRounds) {
            ...
            const winAudio = `${import.meta.env.BASE_URL}audio/beat_chant_bgm/win_loop_1.mp3`;
            soundManager.playBGM(winAudio, 92, 92);
            triggerConfetti('level');
        } else {
            const nextBPM = currentBPM + selectedPack.accelerationRate;
            setCurrentRound(nextRound);
            setCurrentBPM(nextBPM);
            const isContinuous = !roundPause;
            console.log('[BeatChant] handleNextRound. roundPause:', roundPause, 'isContinuous:', isContinuous);
            startRound(nextBPM, isContinuous);
        }
        playSound('start');
    }, [currentRound, selectedPack.accelerationRate, playSound, startRound, currentBPM, triggerConfetti, roundPause]);
    ...
    useEffect(() => {
        const handlePopState = () => {
            if (historyDepthRef.current > 0 && !fadingOut) {
                historyDepthRef.current--;

                // If in settings or creator, just go back to menu instantly without drama
                if (gameState === 'settings' || gameState === 'creator') {
                    setGameState('menu');
                    playSound('switch'); // Optional: nice feedback sound
                } else {
                    // For active gameplay, keep the exit sequence
                    handleExit('menu');
                }
            }
        };

        // Determine intended depth
        let intendedDepth = 0;
        if (gameState === 'settings' || gameState === 'creator') intendedDepth = 1;
        // Reduce game depth to 1 so that Back button (1->0) brings us to Menu (0) cleanly
        if (['countdown', 'playing', 'round-end', 'level-end'].includes(gameState)) intendedDepth = 1;

        // Push state if we are going deeper, but ONLY if not fading out (exiting)
        if (intendedDepth > historyDepthRef.current && !fadingOut) {
            for (let i = historyDepthRef.current; i < intendedDepth; i++) {
                // Use window.location.href to preserve the Hash URL
                window.history.pushState({ depth: i + 1 }, '', window.location.href);
            }
            historyDepthRef.current = intendedDepth;
        }

        window.addEventListener('popstate', handlePopState);
        return () => window.removeEventListener('popstate', handlePopState);
    }, [gameState, fadingOut, handleExit]);
    ...
    // Auto-Advance logic is now handled directly in startRound syncLoop for seamless transition

    const handleSelectPack = (pack) => {
        setSelectedPack(pack);
        setCurrentBPM(pack.startingBPM);
        setCurrentRound(1);
        setTotalRounds(5); // Reset to default when selecting a new pack
    ...
    const handleRandomPack = () => {
        ...
        const random = packs[Math.floor(Math.random() * packs.length)];
        handleSelectPack(random);
    };
    ...
    const handleEditPack = (pack) => {
        const isDefault = INITIAL_PACKS.some(p => p.id === pack.id);

        // Prepare roundWords structure from existing pack
        let initialRoundWords = {
            1: Array(8).fill({ text: '', icon: '❓' }),
            2: Array(8).fill({ text: '', icon: '❓' }),
            3: Array(8).fill({ text: '', icon: '❓' }),
            4: Array(8).fill({ text: '', icon: '❓' }),
        ...
        if (pack.roundWords) {
            initialRoundWords = pack.roundWords;
        } else if (pack.words) {
            // Legacy structure migration
            initialRoundWords[1] = pack.words.map(w => ({ ...w, icon: w.icon || '❓' }));
        }

        setCreatorData({
            name: pack.name,
            startingBPM: pack.startingBPM,
            difficulty: pack.difficulty,
            randomizeCards: pack.randomizeCards !== false,
            roundWords: initialRoundWords
        });
    ...
    const handleResetDefault = (packId) => {
        const newOverrides = { ...overriddenDefaults };
        delete newOverrides[packId];
        setOverriddenDefaults(newOverrides);
        setGameState('menu');
        playSound('trash');
    };
    ...
    const handleSaveCopy = () => {
        const newPack = {
            ...
            category: 'Custom',
            accelerationRate: 5,
            roundWords: creatorData.roundWords,
            randomizeCards: creatorData.randomizeCards,
            words: creatorData.roundWords[1]
        };

        setCustomPacks([...customPacks, newPack]);
        // Don't reset creator here, user might want to continue editing
        setGameState('menu');
        playSound('correct');
    };
    ...
    const handleSaveCustom = () => {
        ...
        const packData = {
            ...creatorData,
            category: 'Custom', // Will be overwritten if default override
            accelerationRate: 5, // Keep standard rate for simplicity
            roundWords: creatorData.roundWords,
            randomizeCards: creatorData.randomizeCards,
            words: creatorData.roundWords[1]
        };

        // SCENARIO 1: Editing a Default Pack (Create Override)
        if (editingPackId && INITIAL_PACKS.some(p => p.id === editingPackId)) {
            const original = INITIAL_PACKS.find(p => p.id === editingPackId);
            const overridePack = {
                ...original,
                ...packData,
                id: editingPackId, // Keep same ID
                category: original.category, // Preserve original category
                accelerationRate: original.accelerationRate
            };
            setOverriddenDefaults({ ...overriddenDefaults, [editingPackId]: overridePack });
        }
        // SCENARIO 2: Editing an Existing Custom Pack (Update)
        else if (editingPackId && customPacks.some(p => p.id === editingPackId)) {
            const updatedCustoms = customPacks.map(p =>
                p.id === editingPackId ? { ...p, ...packData, id: editingPackId } : p
            );
            setCustomPacks(updatedCustoms);
        }
        // SCENARIO 3: Creating New (Add)
        else {
            const newPack = {
                ...packData,
                id: `custom-${Date.now()}`
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full">
                {displayPacks.map((pack, idx) => (
                    ...
                    >
                        ...
                        {pack.isModified && (
                            <div className="absolute -top-2 -left-2 z-20 bg-blue-500 text-white text-[10px] font-black px-2 py-1 rounded-full shadow-lg border border-white/20">
                                EDITED
                            </div>
                        )}

                        <NeonCard
                            className={`cursor-pointer h-full border-2 transition-all ${selectedPack.id === pack.id ? 'border-yellow-400 ring-4 ring-yellow-400/20' : 'border-transparent opacity-90 hover:opacity-100'}`}
                            variant={getDifficultyColor(pack.difficulty).variant}
                            onClick={() => handleSelectPack(pack)}
                        >
                            <div className="flex flex-col h-full p-4 relative overflow-hidden">
                                <div className="flex justify-between items-start mb-4 z-10">
                                    <div className="flex flex-col">
                                        <span className={`text-[10px] font-black px-2 py-0.5 rounded uppercase tracking-tighter mb-1 w-fit ${getDifficultyColor(pack.difficulty).bg} ${getDifficultyColor(pack.difficulty).text}`}>
                                            {pack.difficulty}
                                        </span>
                                ...
                                <div className="grid grid-cols-4 gap-2 mb-8 bg-black/40 p-3 rounded-2xl relative">
            ...
            >
                <NeonCard variant={theme.variant} className={`w-full p-8 ${theme.glow} max-h-[90vh] overflow-y-auto`}>
                    ...
                    <div className="space-y-10">
                        <div className={`bg-gradient-to-r ${theme.grad} p-6 rounded-3xl border border-white/10 flex items-center justify-between`}>
        ...
        >
            <NeonCard variant="purple" className="w-full p-6 overflow-hidden max-h-[90vh] shadow-[0_0_60px_rgba(168,85,247,0.2)] flex flex-col">
                <div className="flex justify-between items-center mb-4 border-b border-white/10 pb-4 shrink-0">
                    ...
                    <div className="flex gap-2">
                        {editingPackId && (
                            <NeonButton variant="blue" size="sm" onClick={handleSaveCopy} className="flex gap-2 text-[10px] py-2">
                ...
                <div className="space-y-4 overflow-y-auto flex-1 min-h-0 pr-2 custom-scrollbar">
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                        <div className="md:col-span-5">
                            ...
                            <input
                                ...
                                className="w-full bg-black/40 border-2 border-white/10 rounded-xl p-3 text-white font-black text-lg focus:border-yellow-400 outline-none transition-all placeholder:text-white/5"
                            />
                        </div>
                        <div className="md:col-span-2">
                            ...
                            <input
                                type="number"
                                value={creatorData.startingBPM}
                                onChange={(e) => setCreatorData({ ...creatorData, startingBPM: parseInt(e.target.value) || 0 })}
                        ...
                        <div className="md:col-span-2">
                            ...
                            <select
                                value={creatorData.difficulty}
                                onChange={(e) => setCreatorData({ ...creatorData, difficulty: e.target.value })}
                                className="w-full bg-black/40 border-2 border-white/10 rounded-xl p-3 text-white font-black text-lg outline-none transition-all appearance-none cursor-pointer"
                            >
                        ...
                        <div className="md:col-span-3 flex items-end">
                            <div className="w-full flex items-center gap-2 bg-white/5 p-3 rounded-xl border border-white/10 h-[56px]">
                                <input
                                    type="checkbox"
                                    id="randomizeCards"
                                    checked={creatorData.randomizeCards}
                                    onChange={(e) => setCreatorData({ ...creatorData, randomizeCards: e.target.checked })}
                                    className="w-5 h-5 accent-yellow-400 cursor-pointer rounded shrink-0"
                                />
                                <div className="flex flex-col leading-none">
                                    <label htmlFor="randomizeCards" className="text-white font-black uppercase tracking-wider cursor-pointer select-none text-[10px]">
                                        Random Order
                                    </label>
                                    <span className="text-[8px] text-white/40 font-bold uppercase tracking-widest mt-0.5">
                                        {creatorData.randomizeCards ? "Shuffle ON" : "Fixed Order"}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-1">
                            ...
                            <div className="text-[8px] text-white/30 font-bold uppercase tracking-widest bg-white/5 px-2 py-0.5 rounded">
                                {currentCreatorRound === 1
                                    ? "R1: Default"
                                    : creatorData.roundWords[currentCreatorRound].some(w => w.text.trim() !== '')
                                        ? `R${currentCreatorRound}: Configured`
                                        : `R${currentCreatorRound}: Uses R1`
                                }
                            </div>
                        </div>
                        <div className="flex space-x-1 mb-2 p-1 bg-black/40 rounded-xl border border-white/10">
                            {[1, 2, 3, 4, 5].map(roundNum => {
                                const hasUnsetWords = creatorData.roundWords?.[roundNum]?.some(w => w.text.trim() !== '');
                                const isRound1 = roundNum === 1;
                                const isEmpty = !hasUnsetWords;

                                return (
                                    <button
                                        key={roundNum}
                                        onClick={() => setCurrentCreatorRound(roundNum)}
                                        className={`
                                            flex-1 py-2 px-1 rounded-lg font-black uppercase tracking-wider text-[10px] transition-all relative overflow-hidden
                                            ${currentCreatorRound === roundNum
                                                ? 'bg-purple-600 text-white shadow-lg'
                                                : 'bg-transparent text-white/30 hover:bg-white/5 hover:text-white/60'
                                            }
                                        `}
                                    >
                                        <div className="z-10 relative flex flex-row items-center justify-center gap-1">
                                            <span>R{roundNum}</span>
                                            {isEmpty && !isRound1 && (
                                                <span className="opacity-50 text-[8px] tracking-tight">(R1)</span>
                                            )}
                                        </div>
                                    </button>
                                );
                    ...
                    <div className="flex-1">
                        <div className="grid grid-cols-4 gap-3">
                            {creatorData.roundWords[currentCreatorRound].map((word, i) => (
                                <motion.div
                                    key={i}
                                    whileFocusWithin={{ y: -2, borderColor: 'rgba(251,191,36,0.5)' }}
                                    className="bg-black/60 p-2 rounded-2xl border-2 border-white/5 space-y-2 focus-within:border-yellow-400/50 transition-all relative overflow-hidden group"
                                >
                                    <div className="flex justify-between items-center">
                                        <span className="text-[8px] font-black text-white/20">#{i + 1}</span>
                                        <input
                                            className="bg-white/5 hover:bg-white/10 border border-white/5 rounded-lg text-xl text-center w-8 h-8 focus:outline-none transition-all cursor-pointer focus:border-yellow-400 p-0"
                                            value={word.icon}
                                            onChange={(e) => {
                                                const newRoundWords = { ...creatorData.roundWords };
                                                const currentRoundList = [...newRoundWords[currentCreatorRound]];
                                                currentRoundList[i] = { ...currentRoundList[i], icon: e.target.value };
                                                newRoundWords[currentCreatorRound] = currentRoundList;
                                                setCreatorData({ ...creatorData, roundWords: newRoundWords });
                                            }}
                                            placeholder="?"
                                        />
                                    </div>
                                    <input
                                        ...
                                        onChange={(e) => {
                                            const newRoundWords = { ...creatorData.roundWords };
                                            const currentRoundList = [...newRoundWords[currentCreatorRound]];
                                            currentRoundList[i] = { ...currentRoundList[i], text: e.target.value };
                                            newRoundWords[currentCreatorRound] = currentRoundList;
                                            setCreatorData({ ...creatorData, roundWords: newRoundWords });
                                        }}
                ...
                <div className="mt-4 flex gap-3 shrink-0 pt-4 border-t border-white/10">
                    {editingPackId && overriddenDefaults[editingPackId] && (
                        <NeonButton
                            variant="default"
                            size="md"
                            className="bg-red-500/20 border-red-500/50 text-red-300 hover:bg-red-500/40 text-xs py-3"
                            onClick={() => handleResetDefault(editingPackId)}
                        >
                    ...
                    <NeonButton
                        ...
                        disabled={!creatorData.name || creatorData.roundWords[1].some(w => !w.text)}
                        className={`flex-1 py-3 text-lg shadow-[0_4px_0_#92400e] ${(!creatorData.name || creatorData.roundWords[1].some(w => !w.text)) ? 'opacity-50 grayscale cursor-not-allowed' : ''}`}
                    >
                        <Save className="mr-2" size={18} /> {editingPackId ? "UPDATE" : "DEPLOY"}
                    </NeonButton>
                </div>
    ...
    const renderGame = () => (
        <div className="flex flex-col items-center w-full max-w-6xl px-4 gap-6 py-8 relative min-h-[80vh]">
            ...
            {roundImages.map((img, idx) => {
                ...
                return (
                    <motion.div
                        key={`${beatPulse}-${idx}`} // Pulse-driven one-shot animation
                        ...
                        animate={{
                            opacity: 0.8,
                            scale: isBeating ? [1, img.scalePulse, 1] : 1,
                            rotate: isBeating ? [img.baseRotation, img.baseRotation + (idx % 2 === 0 ? img.twistAmount : -img.twistAmount), img.baseRotation] : img.baseRotation,
                            y: isBeating ? [0, -img.jumpHeight, 0] : 0,
                            x: isBeating ? [0, img.shakeX, 0] : 0
                        }}
                        transition={{
                    ...
                    >
                        <img
                            src={img.url}
                            alt=""
                            className="w-full h-full object-contain filter drop-shadow-[0_20px_20px_rgba(0,0,0,0.7)]"
                        />
                    </motion.div>
                );
            })}
            ...
            <AnimatePresence>
                {activeSlot !== -1 && (
                    <motion.div
                        ...
                        transition={{ duration: (60 / currentBPM), repeat: Infinity }}
            ...
            >
                <div className="flex items-center gap-6">
                    <div className="w-16 h-16 bg-yellow-400 rounded-3xl flex items-center justify-center text-black shadow-[0_6px_0_#92400e] relative overflow-hidden group">
                        <Music size={32} className="group-hover:rotate-12 transition-transform" />
                        <div className="absolute inset-0 bg-white/30 translate-y-[100%] group-hover:translate-y-[-100%] transition-transform duration-500" />
                    </div>
                    <div>
                ...
                {showBPMMeter && (
                    <div className="flex flex-col items-center bg-black/60 px-8 py-3 rounded-3xl border border-yellow-400/40 relative group overflow-hidden">
                        <div className="absolute inset-0 bg-yellow-400/5 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000" />
                        ...
                        <div className="w-full h-1 bg-white/10 rounded-full mt-2 overflow-hidden">
                            <motion.div
                                ...
                                animate={{ width: `${((currentBPM - 60) / 190) * 100}%` }}
                            />
                        </div>
                    </div>
                )}
                ...
                <div className="flex gap-3">
                    <button
                        ...
                        className={`w-14 h-14 flex items-center justify-center rounded-2xl transition-all border-2 ${isMuted ? 'bg-red-500/10 border-red-500' : 'bg-white/5 border-white/10 hover:bg-white/10'}`}
                    >
            ...
            <div className="w-full max-w-4xl mb-4 z-20">
                <NeonProgressBar
                    value={(currentRound / totalRounds) * 100}
                    color={currentRound > 3 ? 'purple' : 'green'}
                    showButton={false}
                />
            </div>
                        ...
                        <div key={index} className="relative h-56 md:h-64">
                            <AnimatePresence>
                                {isVisible && (
                                    ...
                                    >
                                        <NeonCard
                                            variant={activeSlot === index ? 'yellow' : 'default'}
                                            className={`w-full h-full flex flex-col items-center justify-center transition-all duration-100 relative group
                                                ${activeSlot === index
                                                    ? 'ring-[12px] ring-green-400 shadow-[0_0_70px_rgba(74,222,128,0.6)] z-30'
                                                    : 'ring-2 ring-white/10 grayscale-[0.3] opacity-80'
                                                }`}
                                        >
                                            <div className="absolute inset-0 opacity-[0.05] pointer-events-none rounded-[20px]" style={{
                                            ...
                                            {word.icon && word.icon.trim() !== '' && (
                                                <motion.span
                                                    animate={activeSlot === index ? {
                                                        scale: [1, 1.3, 1],
                                                        rotate: [0, -15, 15, -15, 0],
                                                        filter: ['drop-shadow(0 0 0px #4ade80)', 'drop-shadow(0 0 20px #4ade80)', 'drop-shadow(0 0 0px #4ade80)']
                                                    } : {}}
                                                    transition={{ duration: (60 / currentBPM) }}
                                                    className="text-8xl md:text-9xl mb-6 drop-shadow-[0_20px_20px_rgba(0,0,0,0.5)] z-10"
                                                >
                                                    {word.icon}
                                                </motion.span>
                                            )}
                                            ...
                                            <div className={`
                                                transition-all z-10 w-full flex justify-center
                                                ${activeSlot === index ? 'bg-black text-green-400 font-black px-6 py-2 rounded-xl' : 'text-white/40 font-bold px-2'}
                                            `}>
                                                <span className={`
                                                    uppercase tracking-tighter text-center
                                                    ${(!word.icon || word.icon.trim() === '')
                                                        ? (word.text.length < 5 ? 'text-8xl md:text-9xl' : word.text.length < 10 ? 'text-6xl md:text-8xl' : 'text-4xl md:text-6xl')
                                            ...
                                            {activeSlot === index && (
                                                <motion.div
                                                    layoutId="pulse-glow"
                                                    className="absolute inset-0 rounded-[24px] border-[8px] border-green-400/50 box-content z-[-1]"
                                                    animate={{
                                                        scale: [1, 1.1, 1],
                                                        opacity: [0.5, 0.2, 0.5]
                                                    }}
                    ...
                    >
                        ...
                        >
                            ...
                            <motion.h3
                                ...
                                animate={{ scale: 1, rotate: countdown === 1 ? -15 : 0, opacity: 1 }}
            ...
            <AnimatePresence>
                {gameState === 'round-end' && roundPause && (
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-2xl px-4"
                    >
                        <NeonCard variant="blue" className="p-12 max-w-md w-full text-center relative overflow-hidden shadow-[0_0_100px_rgba(37,99,235,0.3)]">
                            ...
                            <div className="bg-black/40 p-6 rounded-3xl mb-10 border border-white/10 flex flex-col items-center">
                                ...
                                <div className="flex items-baseline gap-2">
                                    <span className="text-4xl font-black text-white italic tabular-nums">{Math.round(currentBPM + selectedPack.accelerationRate)}</span>
                                    <span className="text-sm font-black text-yellow-400 uppercase italic">BPM</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-4">
                                {roundPause ? (
                                    ...
                                    <div className="w-full py-6 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center gap-3">
                                        <div className="w-2 h-2 bg-yellow-400 rounded-full animate-ping" />
                                        <span className="text-white font-black uppercase tracking-widest text-sm italic">Auto-Advancing...</span>
                                    </div>
                                )}
                                <button
                                    onClick={startRound}
                                    className="text-white/20 hover:text-white transition-all py-4 font-black uppercase tracking-[0.2em] text-xs flex items-center justify-center gap-3 group"
                                >
            ...
            <AnimatePresence>
                {gameState === 'level-end' && (
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        className="fixed inset-0 z-[100] flex items-center justify-center bg-[#070814]/99 backdrop-blur-[60px] px-4"
                    >
                        <motion.div
                            initial={{ scale: 0.7, y: 100, rotate: -10 }}
                        ...
                        >
                            ...
                            <NeonCard variant="purple" className="p-14 max-w-xl w-full text-center relative overflow-hidden border-2 border-white/20 shadow-[0_0_150px_rgba(168,85,247,0.4)]">
                                <motion.div
                                    ...
                                    className="text-9xl mb-10 block drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] z-10"
                                >
                                    👑
                                </motion.div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                                    <NeonButton variant="yellow" size="lg" onClick={handleRestart} className="py-6 shadow-[0_8px_0_#92400e]">
                                        TRY AGAIN
                                    </NeonButton>
                                    <NeonButton variant="default" size="lg" onClick={() => handleExit('menu')} className="py-6 border-white/20 bg-white/5 shadow-[0_8px_0_rgba(0,0,0,0.3)]">
                                        HUB HOME
                                    </NeonButton>
                                </div>
                                ...
                                <div className="flex items-center justify-center gap-6 pt-8 border-t border-white/10">
                                    <button className="flex flex-col items-center gap-2 text-white/40 hover:text-white transition-all group">
                                        <div className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center group-hover:bg-blue-500/20 group-hover:text-blue-400 group-hover:border-blue-500/50 border border-transparent transition-all">
                                            <QrCode size={20} />
                                        </div>
                                        <span className="text-[8px] font-black uppercase tracking-widest">Share QR</span>
                                    </button>
                                    <button className="flex flex-col items-center gap-2 text-white/40 hover:text-white transition-all group">
                                        <div className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center group-hover:bg-pink-500/20 group-hover:text-pink-400 group-hover:border-pink-500/50 border border-transparent transition-all">
                                            <Share2 size={20} />
                                        </div>
    ...
    return (
        <div className="min-h-screen bg-[#05060f] flex flex-col items-center justify-center relative overflow-hidden font-['Inter',sans-serif]">
                ...
                {fadingOut && (
                    ...
                    >
                        <motion.div
                            ...
                            className="text-white font-black italic tracking-[1em] text-2xl"
                        >
                            BP BEAT CHALLENGE
                        </motion.div>
                    </motion.div>
