...
import { initTangoSyncListener } from './tango-sync-listener.js';
...
async function initializeApp() {
    ...
    await initDB();
    initTangoSyncListener(); // Initialize Tango synchronization
    ...
    initLessonMenu();
    initSoundBoard();
    console.log("DonDB Classroom Tools Initialized with IndexedDB and Tango Integration!");
}
