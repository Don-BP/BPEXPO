...
import { saveSet, deleteSet, getAllSets, importDecks, saveTangoCardMutedState } from '../db.js';
    ...
    function updateCardListView() {
        ...
        currentCards.forEach((card, index) => {
            ...
            muteBtn.addEventListener('click', async () => {
                ...
                // If this is a Tango card, persist muted state to IndexedDB
                if (card.tangoId) {
                    await saveTangoCardMutedState(card.tangoId, card.muted);
                }
