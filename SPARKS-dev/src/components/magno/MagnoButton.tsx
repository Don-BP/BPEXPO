...
interface MagnoButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
...
const MagnoButton: React.FC<MagnoButtonProps> = ({
    children,
    variant = 'orange',
    size = 'md',
    className,
    ...
    return (
        ...
        >
            ...
            {/* Button Content */}
            <span className={cn("relative z-10 font-black drop-shadow-md flex items-center gap-2 uppercase tracking-wider", theme.text)}>
